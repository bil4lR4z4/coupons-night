...
@section('title', 'Update Disclaimer FAQs')
...
<div class="container py-4">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">Update Disclaimer FAQs</h4>
            <a href="{{ route('admin.disclaimer.index') }}" class="btn btn-secondary btn-sm">Back</a>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.disclaimer.updateAll') }}" method="POST">
                @csrf
