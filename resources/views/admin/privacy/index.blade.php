...
@section('title', 'Privacy Sections')

@section('content')
<div class="container-fluid py-4">

    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Privacy Sections</h4>

        @if($sections->count() == 0)
            <a href="{{ route('admin.privacy.create') }}" class="btn btn-primary">
                Add Privacy Sections
            </a>
        @else
            <a href="{{ route('admin.privacy.editAll') }}" class="btn btn-warning">
