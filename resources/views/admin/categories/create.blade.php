                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="status" class="form-select">
                            <option value="enable" {{ old('status', 'enable') == 'enable' ? 'selected' : '' }}>Enable
                            </option>
                    ...
                    <div class="col-md-6 mb-3 d-flex align-items-end">
                        <div class="w-100">
                            ...
                            <label class="form-check-label border w-100 px-2 pt-1 pb-2 rounded-2" for="mark_home">
                                ...
                                {{ old('mark_home') ? 'checked' : '' }}> Mark on Home Page
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="">
                            ...
                            <label class="form-check-label border w-100 px-2 pt-1 pb-2 rounded-2" for="is_sensitive">
                                ...
                                id="is_sensitive" {{ old('is_sensitive') ? 'checked' : '' }}> Mark as Sensitive / Adult Category
                            </label>
                        </div>
                    </div>
