...
@section('title', 'Update Terms FAQs')
...
<div class="container py-4">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">Update Terms FAQs</h4>
            <a href="{{ route('admin.terms.index') }}" class="btn btn-secondary btn-sm">Back</a>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.terms.updateAll') }}" method="POST">
                @csrf
...
$(document).ready(function () {
    ...
    function initEditor(selector) {
        $(selector).summernote({
            placeholder: 'Write your terms FAQ answer here...',
            height: 250
        });
    }
