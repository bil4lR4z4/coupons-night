    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <!-- <div class="alert alert-info py-2">
                ...
                Current Login:
                <strong>
                    {{ auth()->user()->username ?? auth()->user()->name ?? 'N/A' }}
                </strong>
            </div> -->
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text"
                                       name="coupon_image_line_1"
                                       class="form-control"
                                       value="{{ old('coupon_image_line_1', $coupon->coupon_image_line_1) }}">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text"
                                       name="coupon_image_line_2"
                                       class="form-control"
                                       value="{{ old('coupon_image_line_2', $coupon->coupon_image_line_2) }}">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text"
                                       name="coupon_image_line_3"
                                       id="coupon_image_line_3"
                                       class="form-control"
                                       value="{{ old('coupon_image_line_3', $coupon->coupon_image_line_3) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="is_exclusive" class="form-check-label border w-100 px-2 pt-1 pb-2 rounded-2">
                            <input class="form-check-input" type="checkbox" name="is_exclusive" id="is_exclusive"
                                {{ old('is_exclusive', $coupon->is_exclusive) ? 'checked' : '' }}> Is Exclusive
                        </label>
                    </div>
                    <!-- Coupon Detail -->
                    ...
                    <div class="col-md-4">
                        ...
                        <textarea name="detail"
                                  class="form-control"
                                  rows="3">{{ old('detail', $coupon->detail) }}</textarea>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <div class="form-check d-flex align-items-center">
                                ...
                                <input class="form-check-input mt-0"
                                       ...
                                       name="is_no_code"
                                       id="is_no_code"
                                       {{ old('is_no_code', $coupon->is_no_code) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="date_type"
                            ...
                            <option value="text"
                                {{ old('date_type', $coupon->date_type ?? 'text') == 'text' ? 'selected' : '' }}>
                                Text
                            </option>

                            <option value="calendar"
                                {{ old('date_type', $coupon->date_type ?? '') == 'calendar' ? 'selected' : '' }}>
                                Calendar
                            </option>
                    ...
                    <div class="col-md-4" id="date_text_wrapper">
                        ...
                        <input type="text"
                               name="date_text"
                               class="form-control"
                               value="{{ old('date_text', $coupon->date_text ?? 'Soon') }}">
                        ...
                        <div class="d-flex flex-wrap gap-4">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input"
                                       ...
                                       name="is_homepage"
                                       id="is_homepage"
                                       {{ old('is_homepage', $coupon->is_homepage) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input"
                                       ...
                                       id="is_top_category"
                                       {{ old('is_top_category', $coupon->is_top_category) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input"
                                       ...
                                       id="is_special_offer"
                                       {{ old('is_special_offer', $coupon->is_special_offer) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input"
                                       ...
                                       name="is_verified"
                                       id="is_verified"
                                       {{ old('is_verified', $coupon->is_verified) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        ...
                        <textarea name="html_code"
                                  class="form-control"
                                  rows="3">{{ old('html_code', $coupon->html_code) }}</textarea>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="enable"
                                {{ old('status', $coupon->status) == 'enable' ? 'selected' : '' }}>
                                Enable
                            </option>

                            <option value="disable"
                                {{ old('status', $coupon->status) == 'disable' ? 'selected' : '' }}>
                                Disable
                            </option>
...
$(document).ready(function() {
    ...
    let previousCouponCode = $('#coupon_code').val();
