...
@section('title', 'Update Affiliate FAQs')
...
<div class="container py-4">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">Update Affiliate FAQs</h4>
            <a href="{{ route('admin.affiliate.index') }}" class="btn btn-secondary btn-sm">Back</a>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.affiliate.updateAll') }}" method="POST">
                @csrf
                    ...
                    @forelse($sections as $section)
                        <div class="faq-item border rounded p-3 mb-3">
                            <div class="mb-3">
                                ...
                                <input type="text" name="question[]" value="{{ $section->title }}" class="form-control" placeholder="Enter question" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-semibold">Answer</label>
                                <textarea name="answer[]" class="form-control editor" rows="5" placeholder="Enter answer" required>{!! $section->description !!}</textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-semibold">Sort Order</label>
                                <input type="number" name="sort_order[]" value="{{ $section->sort_order }}" class="form-control">
                            </div>
...
$(document).ready(function () {
    ...
    function initEditor(selector) {
        $(selector).summernote({
            placeholder: 'Write your Affiliate FAQ answer here...',
            height: 250
        });
    }
